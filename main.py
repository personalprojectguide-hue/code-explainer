"""
Code Explainer — Understand any code, fast
...
DB_FILE      = "code_explainer.db"
SYSTEM_PROMPT = "You are an expert Code Explainer assistant. Paste any code snippet and get a clear line-by-line explanation of what it does."
...
<div id="auth-overlay">
  <div class="auth-panel-left">
    <div class="auth-panel-brand">Code Explainer</div>
    <div class="auth-panel-sub">Paste any code snippet and get a clear line-by-line explanation of what it does. Built for users.</div>
  </div>
  <div class="auth-panel-right">
    <div class="auth-box">
      <div class="auth-logo">Code Explainer</div>
      <div class="auth-sub-txt">Understand any code, fast</div>
      <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div style="display:flex;align-items:center;gap:12px">
    <div class="logo"><span>Code Explainer</span></div>
...
<div id="main-app" style="display:none">
  <div class="hero-band">
    ...
    <h1><em>Code Explainer</em><br>Understand any code, fast</h1>
    <p>Paste any code snippet and get a clear line-by-line explanation of what it does. Built for users.</p>
  </div>
  ...
  <div class="below-hero">
    ...
    <footer>
      <div class="foot-note">Code Explainer · Powered by Groq llama-3.3-70b</div>
...
<script>
const APP={name:'Code Explainer',mode:'fastapi',auth:false,systemPrompt:"You are an expert Code Explainer assistant. Paste any code snippet and get a clear line-by-line explanation of what it does.",promptTemplate:"Code Snippet: {{code_snippet}}\\nLanguage: {{language}}",resultFormat:'steps',resultConfig:{"label": "Result", "copyable": true},inputs:[{"id": "code_snippet", "label": "Code Snippet", "type": "textarea", "placeholder": "Enter code snippet...", "required": true}, {"id": "language", "label": "Language", "type": "select", "options": ["Python", "JavaScript", "TypeScript", "Go", "Rust", "Java", "C#", "Other"], "required": false}]};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Code Explainer", "ai_ready": bool(GROQ_API_KEY)}
